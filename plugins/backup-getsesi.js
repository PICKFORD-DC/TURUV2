...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	try {
		...
		await conn.sendMessage(m.chat, {document: database, mimetype: 'application/json', fileName: `database${ini_txt}.json`}, { quoted : m })
		await conn.sendMessage(m.chat, {document: session, mimetype: 'application/json', fileName: `data.store${ini_txt}.json`}, { quoted : m })
		await conn.sendMessage(m.chat, {document: sessions, mimetype: 'application/zip', fileName: `sessions${ini_txt}.zip`}, { quoted : m })
	} catch (e) {
		console.log(e)
